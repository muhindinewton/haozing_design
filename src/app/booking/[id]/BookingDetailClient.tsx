      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="flex gap-1 border-b border-stone-200 mb-6">
          {(['details', 'checkin', 'payment'] as const).map(tab => (
            <button key={tab} onClick={() => setActiveTab(tab)} className={`px-5 py-3 text-sm font-semibold capitalize transition-all border-b-2 -mb-px ${activeTab === tab ? 'border-brand-700 text-brand-700 bg-white' : 'border-transparent text-stone-500 hover:text-brand-700'}`}> 
